defmodule Advent19.ThermalTest do
  ...
  describe "part 1" do
    test "solves the puzzle" do
      assert @opcode |> Runner.start(input: 1) |> Enum.at(-1) == 6_731_945
    end
  end
  ...
  describe "part 2" do
    ...
    test "solves the puzzle to extend the thermal radiators" do
      assert @opcode |> Runner.start(input: 5) |> List.first() == 9_571_668
    end
  end
end
